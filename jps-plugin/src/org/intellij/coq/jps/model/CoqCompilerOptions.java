 ...
 */
public class CoqCompilerOptions  {

    public CoqCompilerOptions() {
    }

    public CoqCompilerOptions(CoqCompilerOptions options) {
        System.out.println("CoqCompilerOptions.init");
